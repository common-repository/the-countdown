...
function the_countdown_plugin_loaded() {
	...
	// Set constant
	define( 'THE_COUNTDOWN_VERSION', '1.1.7' );
	define( 'THE_COUNTDOWN_DIR', plugin_dir_path( __FILE__ ) );
	...
	// Load require file
	require_once( THE_COUNTDOWN_DIR . 'countdown.php' );
 ...
 * @since 1.0.0
 */
function the_countdown_load_widgets( $atts ) {
	// Load widget and register the countdown widget
	require_once( THE_COUNTDOWN_DIR . 'widget.php' );
